export const PERMISSIONS = {
  ...
  CONFIRMATIONS_CANCEL: "confirmations:cancel",
...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  MANAGER: [
    ...
    PERMISSIONS.CONFIRMATIONS_CANCEL,
  ...
  ASSIGNED_WORKER: [
    ...
    PERMISSIONS.PROPERTIES_REVIEW,
    PERMISSIONS.PROPERTIES_APPROVE,
    PERMISSIONS.LOCATION_CATEGORIES_VIEW, // Added for Property Form
    PERMISSIONS.DOCUMENTS_VIEW,
    PERMISSIONS.DOCUMENTS_UPLOAD,
    PERMISSIONS.DOCUMENTS_REVIEW,
    PERMISSIONS.ASSESSMENTS_VIEW,
