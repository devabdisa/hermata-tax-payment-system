...
export interface PropertiesDistribution {
  ...
  byOwnership: { type: string; count: number }[];
}

export interface AssessmentsDistribution {
  totalAssessments: number;
  totalAssessedAmount: number;
  byStatus: { status: string; count: number; totalAmount: number }[];
  byTaxYear: { taxYear: number; count: number; totalAmount: number }[];
}

export interface PaymentsDistribution {
  totalPayments: number;
  totalCollectedAmount: number;
  byStatus: { status: string; count: number; totalAmount: number }[];
  byMethod: { method: string; count: number; totalAmount: number }[];
}
